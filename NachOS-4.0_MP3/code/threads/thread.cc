...
double Thread::get_Burst_Time() {
    return burst_Time;
}

void Thread::set_Burst_Time(double T) {
    burst_Time = T;
}

double Thread::get_Use_Time() {
    return use_Time;
}

void Thread::set_Use_Time(double T) {
    use_Time = T;
}

int Thread::get_Wait_Time() {
    return wait_Time;
}

void Thread::set_Wait_Time(int T) {
    wait_Time = T;
}

double Thread::get_Accumulate_Use_Time() {
    return accumulate_Use_Time;
}

void Thread::set_Accumulate_Use_Time(double T) {
    accumulate_Use_Time = T;
}
